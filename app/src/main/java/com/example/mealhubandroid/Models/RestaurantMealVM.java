...
public class RestaurantMealVM {
    ...
    public RestaurantMealVM(String id,String restaurantId, String category, String foodName, double price, String[] ingredients, String[] portions, BigDecimal totalCalories, BigDecimal totalFat, BigDecimal totalCarbs, BigDecimal totalProtein, String imagePath) {
        this.id=id;
